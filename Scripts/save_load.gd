...
const SETTINGS_PATH: String = "user://settings.sv"


func load_exists()->bool:
	return FileAccess.file_exists(SAVE_PATH)
func loaded_settings_exists()->bool:
...
func load_settings():
	...
	Global.master_volume = line_data["master_volume"]
	Global.music_volume = line_data["music_volume"]
	Global.sfx_volume = line_data["sfx_volume"]
	Global.microphone = line_data["microphone"]
